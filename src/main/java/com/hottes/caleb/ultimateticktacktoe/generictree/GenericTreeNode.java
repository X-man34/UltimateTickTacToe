package com.hottes.caleb.ultimateticktacktoe.generictree;
...
public class GenericTreeNode<T> {
    ...
    public synchronized void addChildAt(int index, GenericTreeNode<T> child) throws IndexOutOfBoundsException {
        child.parent = this;
    ...
    public synchronized void removeChildAt(int index) throws IndexOutOfBoundsException {
        children.remove(index);
    }

    public synchronized GenericTreeNode<T> getChildAt(int index) throws IndexOutOfBoundsException {
